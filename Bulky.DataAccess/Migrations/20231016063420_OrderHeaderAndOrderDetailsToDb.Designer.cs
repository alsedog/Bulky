...
namespace Bulky.DataAccess.Migrations
{
    ...
    [Migration("20231016063420_OrderHeaderAndOrderDetailsToDb")]
    partial class OrderHeaderAndOrderDetailsToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bulky.Models.OrderHeader", b =>
                {
                    b.HasOne("Bulky.Models.ApplicationUser", "ApplicaionUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApplicaionUser");
                });
